...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2017 at 10:44 AM
...
INSERT INTO `citation` (`c_id`, `staff_id`, `operator`, `trans_id`, `c_date`, `c_notes`, `severity`) VALUES
(13, '1000000010', '1000000001', NULL, '2017-12-04 01:23:02', 'This user tried to use tools without proper training.', 1),
(12, '1000000010', '1000000010', NULL, '2017-12-03 11:39:19', 'This is a low-level risk citation.', 0),
(11, '1000000010', '1000000010', NULL, '2017-12-03 11:39:03', 'This is a high-level risk citation.', 1),
(14, '1000000010', '1000000002', NULL, '2017-12-04 02:05:15', 'Modal Test.', 1),
(15, '1000000010', '1000000010', NULL, '2017-12-04 02:06:09', 'Modal Test', 1);
...
(1, 'ABS (Generic)', NULL, 0.00, 'gram(s)', NULL, 'N'),
(2, 'Acrylic', NULL, 0.00, '', NULL, 'N'),
(3, 'Cotton', NULL, 0.00, '', NULL, 'N'),
(4, 'Glass', NULL, 0.00, '', NULL, 'N'),
(5, 'Leather', NULL, 0.00, '', NULL, 'N'),
(6, 'PLA', NULL, 0.05, 'gram(s)', NULL, 'N'),
(7, 'Vinyl (Generic)', NULL, 0.25, 'inch(es)', NULL, 'N'),
(8, 'Wood', NULL, 0.00, '', NULL, 'N'),
(9, 'Basswood', NULL, 0.00, '', NULL, 'N'),
(10, 'Plywood', NULL, 0.00, '', NULL, 'N'),
(11, 'MDF', NULL, 0.00, '', NULL, 'N'),
(12, 'Other', NULL, NULL, '', NULL, 'N'),
(13, 'ABS Black', 1, 0.05, 'gram(s)', '000000', 'Y'),
(14, 'ABS Blue', 1, 0.05, 'gram(s)', '0047BB', 'Y'),
(15, 'ABS Green', 1, 0.05, 'gram(s)', '00BF6F', 'Y'),
(16, 'ABS Orange', 1, 0.05, 'gram(s)', 'fe5000', 'Y'),
(17, 'ABS Red', 1, 0.05, 'gram(s)', 'D22630', 'Y'),
(18, 'ABS Purple', 1, 0.05, 'gram(s)', '440099', 'Y'),
(19, 'ABS Yellow', 1, 0.05, 'gram(s)', 'FFE900', 'Y'),
(20, 'Vinyl Black', 7, 0.25, 'inch(es)', '000000', 'Y'),
(21, 'Vinyl Blue Royal', 7, 0.25, 'inch(es)', NULL, 'Y'),
(22, 'Vinyl Green', 7, 0.25, 'inch(es)', NULL, 'Y'),
(23, 'Vinyl Orange', 7, 0.25, 'inch(es)', NULL, 'Y'),
(24, 'Vinyl Flat Red', 7, 0.25, 'inch(es)', NULL, 'Y'),
(25, 'Vinyl Violet', 7, 0.25, 'inch(es)', NULL, 'Y'),
(26, 'Vinyl Yellow', 7, 0.25, 'inch(es)', NULL, 'Y'),
(27, 'uPrint Material', NULL, 8.19, 'inch<sup>3', 'fdffe2', 'Y'),
(28, 'Learner Supplied Filament', NULL, 0.00, '', NULL, 'Y'),
(29, 'ABS White', 1, 0.05, 'gram(s)', 'ffffff', 'Y'),
(30, 'Vinyl White', 7, 0.25, 'inch(es)', 'ffffff', 'Y'),
(31, 'Transfer Tape', NULL, 0.10, 'inch(es)', NULL, 'Y'),
(32, 'uPrint Support', NULL, 8.19, 'inch<sup>3', NULL, 'Y'),
(33, 'ABS Bronze', 1, 0.05, 'gram(s)', 'A09200', 'Y'),
(35, 'ABS Pink', 1, 0.05, 'gram(s)', 'FF3EB5', 'Y'),
(36, 'ABS Mint', 1, 0.05, 'gram(s)', '88DBDF', 'Y'),
(37, 'ABS Glow in the dark', 1, 0.05, 'gram(s)', 'D0DEBB', 'Y'),
(38, 'ABS Trans Orange', 1, 0.05, 'gram(s)', 'FCC89B', 'Y'),
(39, 'ABS Trans Red', 1, 0.05, 'gram(s)', 'DF4661', 'Y'),
(40, 'ABS Trans White', 1, 0.05, 'gram(s)', 'D9D9D6', 'Y'),
(41, 'ABS Trans Green', 1, 0.05, 'gram(s)', 'A0DAB3', 'Y'),
(42, 'ABS Gold', 1, 0.05, 'gram(s)', 'CFB500', 'Y'),
(43, 'Vinyl Blue Ocean', 7, 0.25, 'inch(es)', NULL, 'Y'),
(44, 'Vinyl Glossy Red', 7, 0.25, 'inch(es)', NULL, 'Y'),
(45, 'Vinyl Pink', 7, 0.25, 'inch(es)', NULL, 'Y'),
(46, 'Vinyl Turquoise', 7, 0.25, 'inch(es)', NULL, 'Y'),
(48, 'Vinyl Silver', 7, 0.25, 'inch(es)', NULL, 'Y'),
(49, 'uPrint Bed New', NULL, 0.00, '', NULL, 'N'),
(50, 'uPrint Bed Partly_Used', NULL, 0.00, '', NULL, 'N'),
(51, 'Delrin Sheet', NULL, 0.00, '', NULL, 'N'),
(52, 'Thread', NULL, 0.23, 'stitch', NULL, 'Y'),
(53, 'Paper-stock (chipboard)', NULL, NULL, '', NULL, 'N'),
(54, 'NinjaFlex (Generic)', NULL, 0.15, 'gram(s)', NULL, 'N'),
(55, 'NinjaFlex Black', 54, 0.15, 'gram(s)', '000000', 'Y'),
(56, 'NinjaFlex White', 54, 0.15, 'gram(s)', 'ffffff', 'Y'),
(57, 'Vinyl Coral', 7, 0.25, 'inch(es)', NULL, 'Y'),
(58, 'Vinyl *Scraps', 7, 0.00, 'inch(es)', NULL, 'Y'),
(59, 'ABS Lime', 1, 0.05, 'gram(s)', 'c2e189', 'Y'),
(60, 'ABS Copper', 1, 0.05, 'gram(s)', '7C4D3A', 'Y'),
(61, 'ABS Silver', 1, 0.05, 'gram(s)', '9EA2A2', 'Y'),
(62, 'ABS Trans Black', 1, 0.05, 'gram(s)', '919D9D', 'Y'),
(63, 'ABS Trans Blue', 1, 0.05, 'gram(s)', 'C8D8EB', 'Y'),
(64, 'ABS Trans Yellow', 1, 0.05, 'gram(s)', 'ECD898', 'Y'),
(65, 'Vinyl Mint', 7, 0.25, 'inch(es)', NULL, 'Y'),
(66, 'Vinyl Lime Green', 7, 0.25, 'inch(es)', NULL, 'Y'),
(67, 'Vinyl Gold', 7, 0.25, 'inch(es)', NULL, 'Y'),
(68, 'Screen Ink(Generic)', NULL, 0.05, 'gram(s)', NULL, 'Y'),
(69, 'NinjaFlex Water', 54, 0.15, 'gram(s)', NULL, 'Y'),
(70, 'NinjaFlex Lava', 54, 0.15, 'gram(s)', NULL, 'Y'),
(71, 'NinjaFlex Sapphire', 54, 0.15, 'gram(s)', NULL, 'Y'),
(72, 'Comet White', 68, 0.05, 'gram(s)', 'ffffff', 'Y'),
(73, 'Pitch Black', 68, 0.05, 'gram(s)', '000000', 'Y'),
(74, 'Neptune Blue', 68, 0.05, 'gram(s)', '0011ff', 'Y'),
(75, 'Mars Red', 68, 0.05, 'gram(s)', 'ff0000', 'Y'),
(76, 'Starburst Yellow', 68, 0.05, 'gram(s)', 'faff00', 'Y');
...
INSERT INTO `offcampus` (`u_id`, `operator`, `r_id`, `exp_date`, `icon`, `adj_date`, `notes`, `fname`, `lname`, `phone`, `email`, `address`, `city`, `state`, `zip`) VALUES
(2, '234567891', 1, NULL, 'user', '2017-12-04 04:38:53', 'Jake is a Learner, glass override to user icon.', 'Jake', 'Madison', 123, 'jake.madison@gmail.com', '678 Madison Drive', 'Arlington', 'Texas', 76011);
...
(1, '1000000010', '2017-12-02 08:08:36', '1000000010', 'Y', NULL, NULL, NULL, NULL);
...
(1, '1000000001', 1, NULL, 'user', '2017-12-04 04:16:22', ''),
(2, '1000000002', 2, NULL, 'user', NULL, ''),
(3, '1000000003', 3, NULL, 'user', NULL, ''),
(4, '1000000004', 4, NULL, 'user', NULL, 'notes'),
(5, '1000000007', 7, NULL, 'tree', NULL, ''),
(6, '1000000008', 8, NULL, 'plane', '2017-12-04 03:41:15', ''),
(7, '1000000009', 9, NULL, 'bicycle', NULL, ''),
(8, '1000000010', 10, NULL, 'institution', '2017-12-04 04:36:04', 'This is the top admin. Highest LevelThis is top admin, highest level.\nupdate test.\nupdate test 2.\n'),
(15, '1000000005', 5, NULL, 'user', NULL, 'New user 5.'),
(16, '1000000006', 6, NULL, 'user', NULL, 'New User 6, added icon "Times" overridden by role ID being 6 to "user".');
